...
export default function OfficesCard({ city, address, phoneNumber }) {
  return (
    <Card className="flex w-full flex-col items-center justify-between gap-3 p-10 px-2 text-start text-campaignBlueDark duration-200 hover:-translate-y-3 hover:scale-105  hover:border-blue-400  hover:shadow-lg md:gap-5 lg:px-10">
      <div className="flex flex-row  justify-between gap-4 align-middle md:gap-6 lg:flex-col lg:items-center ">
        <div className="aspect-square h-[4rem] w-fit rounded-full bg-[#DCF1FF] p-4 group-hover:scale-110 lg:h-[5rem]">
